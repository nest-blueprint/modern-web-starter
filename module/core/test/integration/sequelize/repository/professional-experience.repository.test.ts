...
describe('[Core/Infrastructure] SequelizeProfessionalExperienceRepository', () => {
  ...
  it('Sequelize ProfessionalExperience Repository can be instanced', () => {
    const sequelizeUserRepository = sequelize.getRepository(ProfessionalExperienceEntity);
