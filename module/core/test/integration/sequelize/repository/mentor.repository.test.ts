...
describe('[Core/Infrastructure] SequelizeMentorRepository', () => {
  ...
  it('Sequelize Mentor Repository can be instanced', () => {
    const sequelizeUserRepository = sequelize.getRepository(MentorEntity);
