...
describe('[Core/Infrastructure] SequelizePersonRepository', () => {
  ...
  it('Sequelize Person Repository can be instanced', () => {
    const sequelizeUserRepository = sequelize.getRepository(PersonEntity);
