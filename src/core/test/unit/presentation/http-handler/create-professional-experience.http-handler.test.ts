...
describe('[Core/Presentation] CreateProfessionalExperienceHttpHandler', () => {
  ...
  test('Request /professional_experience (POST) without being logged', async () => {});

  test('Request /professional_experience (POST) with a user account created as customer', async () => {});

  test('Request /professional_experience (POST) with bad or invalid header: authorization JWT token', async () => {});

  test('Request /professional_experience (POST). User account has been created (as mentor) and he is logged in. Invalid request payload sent', async () => {});

  test('Response /professional_experience (POST) when the request has been processed successfully', async () => {});
});
